...
export default function RewardCard({ reward, drawDate }: RewardCardProps) {
  ...
  return (
    <Card className="overflow-hidden border-[#00694B]/20 shadow-md">
      {/* Decorative top bar */}
      <div className="h-1.5 w-full bg-gradient-to-r from-[#00694B] to-emerald-400" />
      ...
      <CardContent className="space-y-3 pb-4">
        ...
        <div className="flex items-center justify-between rounded-lg bg-gray-50 px-3 py-2 text-xs">
          ...
          <span className="font-semibold text-[#00694B]">
            {expiryDate} 止
          </span>
        </div>
