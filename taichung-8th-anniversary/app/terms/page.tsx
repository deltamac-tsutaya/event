...
const SECTIONS = [
  ...
  },
  {
    title: "活動期間與效期",
    items: [
      "活動期間：2026/04/25 00:00 至 2026/05/24 23:59。",
      "Infinity Day 加碼獎開獎時間：2026/05/24 20:00。",
      "一般 LINE 優惠券有效期：統一至 2026/05/30，逾期自動失效。",
      "Infinity Day 加碼獎券有效期：至 2026/06/23（自 2026/05/24 開獎後 30 日內），須於期限內致電或至 WIRED TOKYO 台中市政店預約用餐。",
    ],
  },
  {
    title: "參加資格",
  ...
  },
  {
    ...
    items: [
      ...
      "Infinity Day 加碼獎採全池模式，需於當日完成每日抽獎方可累積加碼獎券，並於 2026/05/24 20:00 全池隨機抽出，現場公開開獎。同一用戶至多得獎 1 份。",
    ],
  },
  {
    title: "獎品使用規則",
    content:
      "Infinity Day 加碼獎須提前致電或至現場預約（如適用），每人限用 1 張，不得拆分使用或由他人代為使用。獎品不得兌換現金，亦不得轉讓他人。獎品使用規則以現場公告為準。",
  },
  {
    title: "兌換與使用限制",
    items: [
  ...
  return (
    <div className="min-h-svh bg-[#F5F2ED] pb-10">
      ...
      <main className="mx-auto max-w-2xl px-4 py-6 space-y-5">
        ...
        <p className="text-center text-[10px] text-gray-400 pt-2">最後更新：2026 / 04 / 25</p>
      </main>
